...
<div style="border:1px solid;background-color:#EB87EA;margin-top:1px;">
	<span style="font-size:20px">第</span> 
	<font size="18" style="color:#F7FA00;"><?php echo $_POST['CustomNumber'] ?></font> 
	<span style="font-size:20px">號客戶商品列表</span>
</div>
